...
- **Sprint name or number:** 1
- **Link to the corresponding Sprint milestone:** [Sprint 1](https://github.com/SWP-Team20/Bilingual-speech-recognition/milestone/1)
- **Sprint start and finish dates:** 15.06.2026-21.06.2026
- **Sprint Goal:** Implement and Verify MVP v1
- **Short focus or expected outcome statement:** MVP v1 successfully implemented and accepted by the customer with all planned user stories completed
...
- **Sprint name or number:** 2
- **Link to the corresponding Sprint milestone:** [Sprint 2](https://github.com/SWP-Team20/Bilingual-speech-recognition/milestone/2)
- **Sprint start and finish dates:** 22.06.2026-28.06.2026
